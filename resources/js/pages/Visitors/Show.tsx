...
import { AlertCircle, Calendar, CheckCircle, Clock, Edit, Mail, MapPin, Phone, Plus, Trash2, User, XCircle } from 'lucide-react';
            ...
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground">Visitor Details</p>
                    </div>
                            ...
                            <div className="space-y-3">
                                <div>
                                    ...
                                    <div className="mt-1 flex flex-wrap gap-2">
                                        ...
                                        {visitor.wants_followup && <Badge variant="outline">Wants Follow-up</Badge>}
                            ...
                            <Dialog open={isFollowUpDialogOpen} onOpenChange={setIsFollowUpDialogOpen}>
                                ...
                                <DialogContent>
                                    <DialogHeader>
                                        ...
                                        <DialogDescription>Create a new follow-up for {visitor.name}</DialogDescription>
                                    </DialogHeader>
                                    ...
                                    <div key={followUp.id} className="rounded-lg border p-4">
                                        <div className="mb-2 flex items-start justify-between">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className="text-sm font-medium capitalize">{followUp.method}</span>
                                            </div>
                                            <div className="text-sm text-gray-500">{format(new Date(followUp.created_at), 'MMM dd, yyyy HH:mm')}</div>
                                        </div>
                                        <p className="mb-2 text-sm text-gray-600">{followUp.note}</p>
